    ...
    <div className="relative bg-gray-100 dark:bg-gray-800">
      {videoUrl ? (
        <video
          ref={videoRef}
          src={videoUrl}
          className="w-full h-auto max-h-96 rounded-t-xl"
          onClick={onVideoClick}
        />
      ) : (
        <div className="w-full h-96 flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 text-gray-500 dark:text-gray-400">
